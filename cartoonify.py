...
def main():
    ...
    #Buttons
    #Smooth Outlines
    Button(panel,text="Smooth Outlines", command=b1,font=Font_b1,height= 3, width=20).place(x=10, y=50)
    #Black Board & Chalks
    Button(panel,text="Black Board & Chalks", command=b2,font=Font_b2,height= 3, width=23).place(x=260, y=50)
    #Black Pen Sketch
    Button(panel,text="Black Pen Sketch", command=b3,font=Font_b3,height= 3, width=20).place(x=460, y=50)
    #Pencil Sketch
    Button(panel,text="Pencil Sketch", command=b4,font=Font_b4,height= 3, width=20).place(x=10, y=150)
    #Colour Pencil
    Button(panel,text="Colour Pencil", command=b5,font=Font_b5,height= 3, width=20).place(x=275, y=150)
    #Crayons
    Button(panel,text="Crayons", command=b6,font=Font_b6,height= 3, width=20).place(x=480, y=150)
    panel.mainloop()
